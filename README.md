...
| **4**    | **30100** (3485 / 26615) изображений                     | 0.970         | 0.977      | 0.990     | 0.955        | ~370 сек.                      |
...
По ТЗ был разработан валидатор, его можно найти по ссылке:
[ravik-games/TBank_Logo_Validation](https://github.com/ravik-games/TBank_Logo_Validation)

В силу особенностей работы YOLO, для отображения предсказаний после валидации необходимо заново их сделать, потому скрипт может потребовать немного времени. На обработку одного изображения, так как там используется Ultralytics, уходит около 100 мс.
